...
final class ReferenceObjectLoader {
    ...
    func loadBuiltInReferenceObjects() async {
        ...
        print("DEBUG!: Looking for reference objects in the main bundle ...")
    ...
    private func loadReferenceObject(_ url: URL) async {
        ...
        do {
            print("DEBUG!: Loading reference object from \(url)")
        ...
        if let usdzPath = referenceObject.usdzFile {
            ...
            do {
                ...
                print("DEBUG!: Failed to load model \(usdzPath.absoluteString)")
            }
